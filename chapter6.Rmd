...
# Look at the wide data, first 10 rows
head(BPRS, 10)
# Look at the long data, first 10 rows
head(BPRSL, 10)
```
...
ggplot(BPRSL, aes(x = week, y = bprs, group = subject)) +
  geom_line()+scale_x_continuous(name = "week (days)", breaks = seq(0, 60, 10))+scale_y_continuous(name = "bprs (grams)")+theme(legend.position = "top")
```
